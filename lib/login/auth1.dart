...
class Auth with ChangeNotifier {
  ...
  void signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBKSbG54xZyv73_hfwDszKj5CujAia4D3U");
    try {
  ...
  void signin(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBKSbG54xZyv73_hfwDszKj5CujAia4D3U");
    try {
      var response = await http.post(
        url,
        body: json.encode({
